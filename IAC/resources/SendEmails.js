...
exports.handler = async function (event) {
    event = event.Payload;
    let allArticles = event.articleResults;
    ...
    let html = "<div style=\"background-color: #383838; padding: 30px;\"><br><h1 style=\"color: white; margin: 15px;\">Your Weekly Cov-Alert Snapshot: </h1><ol style=\"list-style: none;\">";
    allArticles.forEach(function (article) {
    ...
    if(allArticles.length <= 0) {
        html = "<div style=\"background-color: #383838; padding: 30px;\"><br><h1 style=\"color: white; margin: 15px;\">Your Weekly Cov-Alert Snapshot: </h1> <p style=\"color: white; margin: 15px;\">Oops! It looks like there are no relevant recent articles for your area!</p><br></div>";
    }
        
    for(const email of event.userEmails) {
        var params = {
            Destination: {
                ToAddresses: [email],
            },
